...
const Notifications = () => {
  ...
  return (
    <section>
      {/* top part */}
      <div className="flex items-center justify-between pb-9 border-b border-solid border-[#E1E1E1]">
      ...
      <div className="pt-5">
        {notfications.length > 0 ? (
          <div className="flex flex-col gap-5 max-h-[calc(100vh-320px)] overflow-auto">
