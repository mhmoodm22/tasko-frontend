...
const Navbar = () => {
  ...
  const sidebarTriggerBtn = useRef(null);
  ...
  return (
    <header
      ...
      className={`${shortNav ? " h-[120px] lg:h-[175px]" : ""} ${
      ...
      <div className="container">
        <div className="flex items-center justify-between  2xl:flex-row">
          <div className="flex items-center gap-3">
            ...
            <div className=" w-[100px] lg:w-[115px]">
      ...
      >
        <div className="relative pt-5">
          ...
          <ul
            ...
            className="menu--wrap  items-center gap-[50px]  2xl:flex 2xl:flex-row  space-y-6"
          >
            <li className="">
              <NavLink
                to={"/"}
